...
pd_inputs = [
    ...
    ("Drankjes p.p. (welkomstdrankje + drankmunt baruur)", 2, "stuks", False, "Benchmark: markt doet 1, wij 2"),
    ("Inkoopprijs per drankje (afspraak Poort Padel)", 4, "€", True, "Voorstel Lars: €8 p.p. voor 2 drankjes"),
