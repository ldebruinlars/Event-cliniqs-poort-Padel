...
Lars vond versie 13 onoverzichtelijk (veel kleine regels). Het tekstblok is opnieuw opgebouwd in vier lagen: grote datum (ZATERDAG 7 NOVEMBER) met tijd in koraal eronder, drie chips met lime rand (Singles 25 t/m 40 jaar · Nooit gepadeld? Geen probleem), twee bullets met koraal sterretje (4 rondes, elke ronde een nieuwe partner · Daarna het laatste uur samen in de bar); "12 dames & 12 heren" en "12 minuten spelen, 12 minuten praten" op verzoek van Lars geschrapt, en dan prijs-pill, knop en footer. "Speel. Praat. Match." en "rackets liggen klaar" zijn geschrapt om lucht te maken. Feed en story: zelfde opbouw met twee bullets en de lime-tag "Match = gratis baanuur". Bestanden in `events/posters/final/` overschreven; script `build_poster.py` bijgewerkt.

Korrel (20 september 2026, laatste fix): het vlak onder de polaroid wordt nu gevuld met 64 × 64 px stukjes echte achtergrondkorrel uit het beeld, alleen gesampled waar het origineel puur achtergrond is (geen doodles, tekst of pills), willekeurig gedraaid en gespiegeld, 2× opgeschaald en verscherpt op dezelfde manier als de illustratie. Daardoor is de korrel onder en boven de naad gelijk; de eerdere versie was zachter en bevatte restjes lime.

### Versie 15: geen naad meer (20 september 2026)

Lars zag een tint- en korrelverschil tussen het beeld en het vlak eronder. Nieuwe opbouw in `events/posters/final/build_poster.py`: het beeld blijft in zijn eigen 3:4-verhouding (2986 × 4000 na 2× opschalen), de oude tekst, pills en footer worden in het beeld zelf gewist (samenhangende vormen in het midden onder de polaroid; de sterretjes aan de zijkanten blijven staan), en elk gewist pixel wordt gevuld met korrel uit dezelfde hoogte van het beeld. Er is dus geen apart vlak en geen naad meer. De nieuwe tekst staat op dezelfde plek als de oude. Feed 4:5 en story 9:16 werken hetzelfde; de randen die daar bijkomen worden gevuld met korrel uit de dichtstbijzijnde rand van het beeld.

Bestanden: `padel-dating-poster-A-print-boutiq-30x40cm.pdf` (+ `.jpg`), `padel-dating-poster-A-print-zonder-boutiq-30x40cm.pdf` (+ `.jpg`), `padel-dating-ig-feed-4x5.jpg`, `padel-dating-ig-story-9x16.jpg`. Print: 30 × 40 cm op 253 dpi; A3 met kleine rand kan ook.
