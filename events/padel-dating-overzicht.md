# Padel Dating bij Poort Padel: overzicht (stand 20 september 2026)

## Het event

| | |
|---|---|
| Datum | Zaterdag 7 november 2026 |
| Tijd | 19:00 tot 22:00, inloop 18:30, opbouw 17:45 |
| Locatie | Poort Padel, Neonweg 62, Almere |
| Doelgroep | Singles van 25 t/m 40 jaar, 12 dames en 12 heren (minimaal 16 om door te gaan, ondergrens 12 in de voorwaarden) |
| Format | 6 banen, iedereen tegelijk op de baan, 4 per baan. 4 rondes: 12 minuten spelen, 12 minuten praten aan de statafels naast de banen met je volgende partner. Daarna het laatste uur samen in de bar (21:00 tot 22:00) |
| Rotatie | dame Dn speelt in ronde r met heer H((n + r − 1) mod 12 + 1); alle 12 koppels tegelijk op de baan |
...
## Prijsoverzicht (24 deelnemers, alles excl. btw)
...
- Aanmelden via allcourtacademy.com/events met betaallink (Make-scenario "betaallink" bestaat). Twee tellers: dames en heren. Zit een kant op 12, dan wachtlijst. Geboortejaar vragen, 1 of 2 jaar buiten de grens gewoon toelaten.
- Vrouwen zijn onder de 45 de schaarse kant bij elk dating-event. Start de campagne gericht op vrouwen 25 tot 40: Meta-advertentie (€75, straal 15 km rond Almere), "stuur dit naar je single vriendin", vriendinnen mogen samen komen.
- Campagne van donderdag 15 oktober tot donderdag 5 november; volledige kalender D1 tot D14 met captions in `events/social-posts.md`. Instagram: beste tijden 10:00 op werkdagen, reels doen het 5 tot 10× beter dan foto's.
- Voorwaarde bij aanmelding: bij minder dan 16 aanmeldingen op donderdag 5 november wordt het event verplaatst, geld terug of plek in de volgende editie.

## Bestanden

- Posters, feed en story: `events/posters/final/` (print-PDF 30 × 40 cm met en zonder BoutiQ, JPG's, feed 4:5, story 9:16, bouwscript)
- Rekenmodel: `pricing/prijscalculator.xlsx`
- Draaiboek en concept: `events/padel-dating.md`
- Datumonderzoek: `events/padel-dating-datum.md`
- Leeftijd, benchmark en drankjes: `events/padel-dating-leeftijd.md`
- Social kalender en captions: `events/social-posts.md`
- Meer eventideeën: `events/sociale-events.md`

## Instagram-post (feed) 

Beeld: `padel-dating-ig-feed-4x5.jpg`. Caption:
...
Story (9:16, `padel-dating-ig-story-9x16.jpg`): link-sticker naar allcourtacademy.com/events, tekst-sticker "Stuur dit naar je single vriendin 💌". Plaatsen op donderdag 15 oktober om 10:00 (feed) en 18:00 (story).
